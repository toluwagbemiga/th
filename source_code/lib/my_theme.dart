...
class MyTheme {
  ...
  static Color accent_color = Color.fromRGBO(42, 41, 94, 1);
  static Color accent_color_shadow =
      Color.fromRGBO(25, 16, 107, 0.4); // this color is a dropshadow of
  static Color soft_accent_color = Color.fromRGBO(175, 182, 216, 1);
  static Color splash_screen_color = Color.fromRGBO(
      42, 41, 94, 1); // if not sure , use the same color as accent color
